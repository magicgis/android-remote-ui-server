...
//                    drawRect(c.getPosX(), c.getPosY(), c.getOuterWidth(), (c.getValues().length + 1) * c.getOuterHeight(), 3, "#0000ff");
                ...
                if (((DefaultToggleButton) comp).isPressed()) {
                    fillRect(b.getPosX(), b.getPosY(), b.getOuterWidth(), b.getOuterHeight(), b.getInnerColor());
                    ...
                    fillRect(b.getPosX(), b.getPosY(), b.getOuterWidth(), b.getOuterHeight(), b.getInnerColorPressed());
